...
expected_paid_date,description,milestone_pcnt pcnt
...
<form name="projectForm" action="updategeninvoice.php" method="post" onsubmit="return formSubmit();" >
<table>
<tr>
 <td> Milestone : </td>
                <td>
...
<tr>
<td>Invoice No : </td>
<td> <input type = "text" id="InvoiceNo" name="InvoiceNo" autofocus required></td>
<td>Invoiced Date : </td>
