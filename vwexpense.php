...
$coned=getConnection();
$sqled="
SELECT for_emp, status,a.expense_id,expense_type,a.project_id project_id, c.customer_id customer_id, c.name project_name,d.name customer_name,expense_details, expense_date,expense_amt,pay_details,pay_part FROM expense_details a
...
<?php
echo "<td>  <textarea  name='PaymentDet' id='PaymentDet' rows='4' cols='50'>$rowed[pay_details]</textarea></td>";
echo "<script>document.getElementById('PaymentDet').disabled=true;</script>";
...
<tr>
<td>Cheque No. : </td>
<?php echo"<td>  <input type='text' name='PayPart' id='PayPart' value='$rowed[pay_part]'></td>";
echo "<script>document.getElementById('PayPart').disabled=true;</script>";?>
</tr>
<tr>
