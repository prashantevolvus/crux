...
<br>
<td>
<font size="3" face="arial"><b>Update Project Status</b></font>
</td>
<?
 if($rowed[tlr]=="GREEN")
...
<td> <input type = "number" id="Extension1" name="Extension1" value=0></td>
<td>Projected End Date</td>
<td> <input type = "date" id="ProjEndDate" name="ProjEndDate"><b>
<?echo "End Date ".$rowed[tr]." ".$rowed[pp]." Days"; ?></b>
</td>

</tr>
<tr><td>Additional Extension in Days :</td>
...
echo "<script>document.getElementById('Extension1').value = '$rowed[extension]';</script>";
echo "<script>document.getElementById('Extension1').disabled=true;</script>";
