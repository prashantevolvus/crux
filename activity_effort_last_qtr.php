...
<!-- Example scripts go here -->
    ...
    <div id="pie22" style="margin-top:20px; margin-left:20px; width:400px; height:400px;"></div>
<?
require_once('dbconn.php');
$con=getConnection();
...
$(document).ready(function(){ 
    ...
    var plot8 = $.jqplot('pie22', [tempArr_effort], {
        grid: {
            drawBorder: true, 
            drawGridlines: true,
            background: '#ffffff',
		...
		title: {
			text: 'Top 10 Activities - Effort(Last 3 Months)',
			show: true
		},
        legend: {
            show: true,
