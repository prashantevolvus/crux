...
if(checkPermission("DELETE") == false)
{
...
$coned=getConnection();
$sqled="
SELECT for_emp, status,a.expense_id,expense_type,a.project_id project_id, c.customer_id customer_id, c.name project_name,d.name customer_name,expense_details, expense_date,expense_amt FROM expense_details a
...
$resulted = mysqli_query($coned,$sqled) or die($sqled."   failed  <br/><br/>".mysql_error());
$rowed = mysqli_fetch_array($resulted);
?>
<h3>Delete Expense</h3>
<form name="expenseForm" action="updatedel.php" method="post" onsubmit="return formSubmit();" >
<?
echo "<table>";
echo "<tr>";
echo "<td>";
