...
<form  name="expenseForm" action="update_expense.php" method="post" enctype="multipart/form-data" onsubmit="return formSubmit();" >
<table>
<tr>
...
<td>
<label for="altText">Description of Bill</label>
<td>
<input type="text" size="60" name="altText" id="altText" required/><br />
</td>
