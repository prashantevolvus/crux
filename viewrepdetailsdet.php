...
<tr>
<td>  <textarea rows=10 cols=45 id='prev_pm_report'  name='prev_pm_report' requried><?php echo $rowed[prev_pm_report];?></textarea>
<td>  <textarea rows=10 cols=45 id='curr_pm_report'  name='curr_pm_report' requried><?php echo $rowed[curr_pm_report];?></textarea>
<td>  <textarea rows=10 cols=45 id='prev_pm_risk_perception'  name='prev_pm_risk_perception' requried><?php echo $rowed[prev_pm_risk_perception];?></textarea>
<td>  <textarea rows=10 cols=45 id='curr_pm_risk_perception'  name='curr_pm_risk_perception' requried><?php echo $rowed[curr_pm_risk_perception];?></textarea>
</tr>
...
<tr>
<td>  <textarea rows=10 cols=45 id='prev_pd_report'  name='prev_pd_report' requried><?php echo $rowed[prev_pd_report];?></textarea>
<td>  <textarea rows=10 cols=45 id='curr_pd_report'  name='curr_pd_report' requried><?php echo $rowed[curr_pd_report];?></textarea>
<td>  <textarea rows=10 cols=45 id='prev_pd_risk_perception'  name='prev_pd_risk_perception' requried><?php echo $rowed[prev_pd_risk_perception];?></textarea>
<td>  <textarea rows=10 cols=45 id='curr_pd_risk_perception'  name='curr_pd_risk_perception' requried><?php echo $rowed[curr_pd_risk_perception];?></textarea>
</tr>
...
<tr>
<td>  <textarea rows=10 cols=45 id='prev_approver_report'  name='prev_approver_report' requried><?php echo $rowed[prev_approver_report];?></textarea>
<td>  <textarea rows=10 cols=45 id='curr_approver_report'  name='curr_approver_report' requried><?php echo $rowed[curr_approver_report];?></textarea>
