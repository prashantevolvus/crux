...
<td>  <textarea rows=5 cols=40 id="Desc" name="Desc" required><?php echo $rowed[risk_desc]?></textarea>
 </td>
</tr>
<tr>
<td>Containment Plan : </td>
<td>  <textarea rows=5 cols=40 id="Containment" name="Containment" required><?php echo $rowed[containment_plan]?></textarea>
 </td>

<td>Contingent Plan : </td>
<td>  <textarea rows=5 cols=40 id="Contingent" name="Contingent" required><?php echo $rowed[contingent_plan]?></textarea>
 </td>
</tr>
<tr>
<td>Cost of Risk : </td>
