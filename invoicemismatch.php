...
contract_value,
ifnull(CR_value,0) CR_value ,
contract_value + ifnull(CR_value,0)  'total_val',
ifnull(invoice_amt,0) invoice_amt,
contract_value + ifnull(CR_value,0) - ifnull(invoice_amt,0)  as 'diff',
a.status,
a.id 
...
$col=array(
			...
			array("Project","project_ref","viewprojexpdetails.php",8),
