...
$coned=getConnection();
$sqled="
select invoice_id,cr_id,project_id, ohrm_customer_id customer_id, mile_stone,lcy_amount,project_ccy_amount,a.status,expected_invoice_date,
...
<td> <input type = "date" id="CRPayDate" name="CRPayDate" required></td>
</tr>
<tr>
