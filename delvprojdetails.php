...
<br>
<td>
<font size="3"><b>Make Project Phase Delivered</b></font>
</td>
<?
 if($rowed[tlr]=="GREEN")
...
echo "<b><input name='byFld' id='byFld'  type='hidden' value='project_delivered_by'></b>";
echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='DELIVERED'></b>";
echo "<b><input name='onFld' id='onFld'  type='hidden' value='project_delivered_on'></b>";
?>
...
<tr>
<td>
<input type="submit"  value="Set Delivered Phase">
</td>
</tr>
</table>
<td> 
