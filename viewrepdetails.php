...
<div id="tabs">
<ul>
<li><a href='viewrepdetailsinfo.php?rep_id=<?php echo $repid?>'>Information</a> </li>
<li><a href='viewrepdetailsfin.php?rep_id=<?php echo $repid?>'>Financials</a> </li>
<li><a href='viewrepdetailsqlt.php?rep_id=<?php echo $repid?>'>Quality</a> </li>
<li><a href='viewrepdetailsscope.php?rep_id=<?php echo $repid?>'>Scope</a> </li>
<li><a href='viewrepdetailsdet.php?rep_id=<?php echo $repid?>'>Details</a> </li>
<li><a href='getinvoicelist.php?q2=<?php echo $rowed[project_id]?>&rep=true'>Invoice</a> </li>
<li><a href='viewprojtimebookedreport.php?proj_id=<?php echo $rowed[project_id]?>&q1=Last Week'>Time Booked</a> </li>
<li><a href='getrisklist.php?q=<?php echo $rowed[project_id]?>&rep=true'>Risk</a> </li>
<li><a href='getexplist.php?q=<?php echo $rowed[project_id]?>&rep=true'>Expenses</a> </li>
<?php
