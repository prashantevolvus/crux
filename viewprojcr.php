...
document.getElementById('txtCR').removeChild(document.getElementById('finance'));
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
        document.getElementById('txtCR').removeChild(document.getElementById('ajaxloader'));
...
function BeginLoading(){
    ...
    document.getElementById('txtCR').appendChild(eLoader);
...
<tr>
<td>                    <div id="txtCR"><table id="finance"></table></div> </td>
<?php echo"<script>showCR($rowed[id]);</script>";?>
</tr>
