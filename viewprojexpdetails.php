...
<form name="timesheetListForm" >
	<div class="form-group">
  		<div class="row">
  			<div class="col-xs-4">
  					<label for="status" class="wb-inv">Customer</label> 
...
include 'getcustomer.php'; ?>
  					...
  					<label for="status" class="wb-inv">Project</label> 

		 <input type = "text" id='proj' name='proj' size='50'>
	</div>
...
<li><a href='getbudgetAw.php?q=<?php echo $projid ?>'>Financial Summary</a> </li>
<li><a href='getexcessbudget.php?q=<?php echo $projid ?>'>Budget</a> </li>
<li><a href='getlabourcost.php?q=<?php echo $projid ?>'>Labour Cost</a> </li>
<li><a href='getlaboursummary.php?q=<?php echo $projid ?>'>Labour Summary</a> </li>

<li><a href='getexpsummary.php?q=<?php echo $projid ?>'>Expense Summary</a> </li>
<li><a href='getexplist.php?q=<?php echo $projid ?>'>Expense Details</a> </li>
<li><a href='getchangerequestlist.php?q2=<?php echo $projid ?>'>Change Request</a> </li>
<li><a href='getinvoicelist.php?q2=<?php echo $projid ?>'>Invoice</a> </li>
<li><a href='getMonthlySpend.php?q=<?php echo $projid ?>'>Get Monthly Spend</a> </li>
</ul>
</div>
<div id="content"><img id="loading_indicator" src="images/loader.gif" 
