...
<td>  <textarea rows=5 cols=40 name="Desc" required><?echo $rowed[risk_desc]?></textarea>
 </td>
</tr>
<tr>
<td>Containment Plan : </td>
<td>  <textarea rows=5 cols=40 name="Containment" required><?echo $rowed[containment_plan]?></textarea>
 </td>

<td>Contingent Plan : </td>
<td>  <textarea rows=5 cols=40 name="Contingent" required><?echo $rowed[contingent_plan]?></textarea>
 </td>
</tr>
<tr>
<td>Cost of Risk : </td>
<td><input type="number" id="riskcost" name="riskcost" step="" value="<?echo $rowed[risk_cost]?>"></td>
</tr>
