...
$coned=getConnection();
$sqled="
select cr_name,a.project_id,c.customer_id,cr_id , c.name customer , b.project_name, 
...
<tr>
<td>Description : </td>
<td>  <textarea rows=10 cols=60 id="Desc" name="Desc" required><?php echo $rowed[description];?></textarea>
 </td>
</tr>
