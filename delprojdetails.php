...
if(checkProjectPermission("DELETE") == false)
{
...
if(!($rowed[status] == "INITIATED"  or $rowed[status] == "AUTHORISED"))
...
<br>
<td>
<font size="3"><b>Delete Project</b></font>
</td>
<?php
 if($rowed[tlr]=="GREEN")
...
echo "<b><input name='byFld' id='byFld'  type='hidden' value='project_deleted_by'></b>";
echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='DELETED'></b>";
echo "<b><input name='onFld' id='onFld'  type='hidden' value='project_deleted_on'></b>";
?>
