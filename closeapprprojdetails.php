...
if(checkProjectPermission("CLOSE") == false)
{
...
Objectives, Scope, success_factor, docurl,project_close_status,project_close_remarks
...
if($rowed[status] != "AUTHORISE CLOSURE" )
...
<br>
<td>
<font size="3"><b>Approve Project Closure</b></font>
</td>
<?php
 if($rowed[tlr]=="GREEN")
...
echo "<b><input name='byFld' id='byFld'  type='hidden' value='project_closed_by'></b>";
echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='CLOSED'></b>";
echo "<b><input name='onFld' id='onFld'  type='hidden' value='project_closed_on'></b>";
?>
...
<td> <input type = "date" id="ActualEndDate" name="ActualEndDate" required></td>
 </td>
</tr>
...
<td>Scope : </td>
<?php echo "<td>  <textarea rows=5 cols=40 id='Scope' name='Scope' required>$rowed[Scope]</textarea>";?>
 </td>
</tr>
...
<tr>
<td>Closing Status Remarks : </td>
<td>  <textarea rows=5 cols=40 id="remAction" name="remAction" required><?echo $rowed[project_close_remarks];?></textarea>
 </td>
<td>
<select id='statusAction' name='statusAction' value =''>
        <option value='SUCCESS'>SUCCESS</option>
        <option value='FAILURE'>FAILURE</option>
</select>
</td>
<?
echo $rowed[project_close_remarks];
echo "<script>document.getElementById('remAction').value = '$rowed[project_close_remarks]';</script>";
echo "<script>document.getElementById('remAction').disabled=true;</script>";
echo "<script>document.getElementById('statusAction').value = '$rowed[project_close_status]';</script>";
echo "<script>document.getElementById('statusAction').disabled=true;</script>";
?>

</tr>
<tr>
<td>
<input type="submit"  value="Approve Project Closure">
</td>
</tr>
</table>
<td> 
