...
class POP3 {
   ...
   * @return bool
   */
  public function Authorise ($host, $port = false, $tval = false, $user_name, $password, $debug_level = 0) {
    $this->host = $host;
    ...
    if ($result) {
      $login_result = $this->Login($this->user_name, $this->password);
  ...
  public function Login ($user_name = '', $password = '') {
    ...
    $pop_username = "USER $user_name" . $this->CRLF;
