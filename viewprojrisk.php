...
project_deactivated_on, f.pc_id as pc_identity
...
function showRisk(str)
{
//Not requrired for define. Required for others
if(str=='Choose..')
        return;

document.getElementById('txtRisk').removeChild(document.getElementById('finance'));
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
        document.getElementById('txtRisk').removeChild(document.getElementById('ajaxloader'));
        document.getElementById("txtRisk").innerHTML=xmlhttp.responseText;
    }
  }
...
function BeginLoading(){
    ...
    document.getElementById('txtRisk').appendChild(eLoader);
...
<tr>
<td>                    <div id="txtRisk"><table id="finance"></table></div> </td>
<?php echo"<script>showRisk($rowed[id]);</script>";?>
</tr>
