...
if(checkProjectPermission("AUTHCLOSE") == false)
{
...
if($rowed[status] != "INITIATE CLOSURE" )
...
<br>
<td>
<font size="3"><b>Authorise Project Closure</b></font>
</td>
<?php
 if($rowed[tlr]=="GREEN")
...
echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='AUTHORISE CLOSURE'></b>";
...
<tr>
<td>
<input type="submit"  value="Authorise Project Closure">
</td>
</tr>
</table>
<td> 
