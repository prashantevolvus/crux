...
Objectives, Scope, success_factor, docurl, f.pc_id as pc_identity
...
<br>
<td>
<font size="3" face="arial"><b>Authorise Project</b></font>
</td>
<?php
 if($rowed[tlr]=="GREEN")
...
echo "<b><input name='byFld' id='byFld'  type='hidden' value='project_authorised_by'></b>";
echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='AUTHORISED'></b>";
echo "<b><input name='onFld' id='onFld'  type='hidden' value='project_authorised_on'></b>";
echo "<b><input name='remFld' id='remFld'  type='hidden' value='project_auth_remarks'></b>";
?>
...
<?php echo "
<td>  <textarea rows=5 cols=40 id='remAction' name='remAction' autofocus requried>$rowed[project_auth_remarks]</textarea>";?>
 </td>
 </tr>
<tr>
<?php
...
<tr>
<td>
<input type="submit"  value="Authorise Project">
</td>
</tr>
</table>
<td> 
