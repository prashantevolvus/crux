...
if(checkProjectPermission("ACTIVATE") == false)
{
...
if(!($rowed[status] == "APPROVED" || $rowed[status] == "DEACTIVATED" || $rowed[status] == "PENDING INVOICE"))
...
<br>
<td>
<font size="3"><b>Activate Project</b></font>
</td>
<?php
 if($rowed[tlr]=="GREEN")
...
echo "<b><input name='byFld' id='byFld'  type='hidden' value='project_activated_by'></b>";
//echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='ACTIVE'></b>";
echo "<b><input name='onFld' id='onFld'  type='hidden' value='project_activated_on'></b>";
?>
...
include 'getcustomer.php'; ?>
		...
		<td> <input type = "text" id='proj' name='proj' size='50'></td>
		 ...
		 <input type = "hidden" id='projPost' name='projPost' size='50'></td>
		 <input type = "hidden" id='custPost' name='custPost' size='50'></td>
		 <input type = "hidden" id='pmPost' name='pmPost' size='50'></td>
	</tr>
...
echo "<script>document.getElementById('custPost').value = '$rowed[customer_id]';</script>";
...
echo "<script>document.getElementById('projPost').value = '$rowed[project_name]';</script>";
echo "<script>document.getElementById('pmPost').value = '$rowed[project_manager_id]';</script>";
...
<td> 
<select id='statuschg' name='statuschg' value =''>
...
<td>  
<input type="text" name="ContractVal" id="ContractVal">
<input type="hidden" name="ContractValPost" id="ContractValPost">
 </td>
<td>License Value : </td>
<td>  
<input type="text" name="LicenseVal" id="LicenseVal">
<input type="hidden" name="LicenseValPost" id="LicenseValPost">
 </td>
</tr>
<?
echo "<script>document.getElementById('ContractVal').value = '$rowed[Contract_value]';</script>";
echo "<script>document.getElementById('ContractValPost').value = '$rowed[Contract_value]';</script>";
...
echo "<script>document.getElementById('LicenseValPost').value = '$rowed[License_value]';</script>";
...
<td>  
<input type="text" id="BudgetVal" name="BudgetVal">
<input type="hidden" id="BudgetValPost" name="BudgetValPost">
 </td>

</tr>
<?
echo "<script>document.getElementById('BudgetVal').value = '$rowed[budget]';</script>";
echo "<script>document.getElementById('BudgetValPost').value = '$rowed[budget]';</script>";
...
echo "<script>document.getElementById('ObjectivesPost').value = '$rowed[Objectives]';</script>";
...
<tr>
<td>
<input type="submit"  value="Activate Project">
</td>
</tr>
</table>
<td> 
