...
<tr>
<td> Budget Name: </td>
<td><input type="text" cols='30' id="budgetname" name="budgetname" value='<?php echo $rowed[budget_name]?>'></td>

<td>Budget : </td>
<td>
<input type="text" id="excess" name="excess">
<input type="hidden" id="excessPost" name="excessPost">
<td>
</tr>
<tr>
<td>Reason for Budget : </td>
<?php echo "<td>  <textarea rows=5 cols=40 name='Reason' id='Reason'>".$rowed[reason]."</textarea>";?>
 </td>
</tr>
<tr>
<td>
<?php echo "<td><a href='$rowed[docurl]'>Links to Documentation and Estimation</a></td>";?>
...
echo "<script>document.getElementById('excessPost').value = '$rowed[excess_budget]';</script>";
...
echo "<script>document.getElementById('category').value = '$rowed[category]';</script>";
echo "<script>document.getElementById('category').disabled=true;</script>";
echo "<script>document.getElementById('crvalue').value = '$rowed[crvalue]';</script>";
echo "<script>document.getElementById('crvalue').disabled=true;</script>";
...
<td> 
<input type="submit"  value="Authorise Budget"> 
<?php
echo "<b><input name='bud_id' id='bud_id' type='hidden' value='$budid'></b>";
echo "<b><input name='bud_cat' id='bud_cat' type='hidden' value='$rowed[category]'></b>";
echo "<b><input name='byFld' id='byFld'  type='hidden' value='authorised_by'></b>";
echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='AUTHORISED'></b>";
