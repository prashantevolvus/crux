...
class SMTP {
   ...
   * @return bool
   */
  public function Authenticate($user_name, $password, $authtype='LOGIN', $realm='', $workstation='') {
    if (empty($authtype)) {
      $authtype = 'LOGIN';
    }
    ...
    switch ($authtype) {
      case 'PLAIN':
        ...
        // Send encoded username and password
          $this->client_send(base64_encode("\0".$user_name."\0".$password) . $this->CRLF);
      ...
      case 'LOGIN':
        ...
        $this->client_send(base64_encode($user_name) . $this->CRLF);
      ...
      case 'NTLM':
        ...
        $msg3 = $ntlm_client->TypeMsg3($ntlm_res, $user_name, $realm, $workstation);//msg3
        // Send encoded username
      ...
      case 'CRAM-MD5':
        ...
        // Build the response
        $response = $user_name . ' ' . $this->hmac($challenge, $password);
