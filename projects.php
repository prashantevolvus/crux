    ...
    function populateForm(projid) {
        ...
        $.getJSON(url, function(data) {
            ...
            if (data[0]['noofdays'] < 0) {
                ...
                $('#5A5').html("Passed End Date");
                $('#5B5').html(data[0]['projected_end_date']);
            } else {
                                ...
                                <td>
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-default " id="EXTN" aria-label="Left Align">
