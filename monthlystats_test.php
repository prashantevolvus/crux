...
<script class="code" type="text/javascript">$(document).ready(function(){
        plot5 = $.jqplot('chart1', [[[<?php echo $row1[cr_pending];?>,'CR Pending'],
[<?php echo $row1[cr_accepted];?>,'CR Accepted'],
[<?php echo $row1[contract_value];?>,'contract_value'],
[<?php echo $row1[amt_uninvoiced];?>,'Uninvoiced'], 
[<?php echo $row1[amt_invoiced];?>,'Invoiced'],
[<?php echo $row1[amt_received];?>,'Received'],
[<?php echo $row1[unifiedcost]+$row1[ expense_amt];?>,'Cost']]], {
