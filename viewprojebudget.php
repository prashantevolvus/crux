...
function showExcessBudget(str)
{
//Not requrired for define. Required for others
if(str=='Choose..')
        return;

document.getElementById('txtExcessBudget').removeChild(document.getElementById('finance'));
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
        document.getElementById('txtExcessBudget').removeChild(document.getElementById('ajaxloader'));
        document.getElementById("txtExcessBudget").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","getexcessbudget.php?q="+str,true);
...
function BeginLoading(){
    ...
    document.getElementById('txtExcessBudget').appendChild(eLoader);
...
<br>
<td>
<font size="3"><b>View Excess Budget Details</b></font>
</td>
<?
 if($rowed[tlr]=="GREEN")
...
<tr>
<td>                    <div id="txtExcessBudget"><table id="finance"></table></div> </td>
<?php echo"<script>showExcessBudget($rowed[id]);</script>";?>
</tr>
