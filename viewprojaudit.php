...
getEmpName(project_approved_by) apprv_by,
project_approved_on,  f.pc_id as pc_identity
...
<br>
<td>
<font size="3"><b>View Project Audit</b></font>
</td>
<?php
 if($rowed[tlr]=="GREEN")
...
{
	echo "<tr>";
	echo "<td>INITIATION</td>";
	echo "<td>$rowed[crt_by]</td>";
	echo "<td>$rowed[project_created_on]</td>";
	echo "</tr>";
}
if ($rowed[mod_by] !="")
{
	echo "<tr>";
        echo "<td>MODIFIED</td>";
        echo "<td>$rowed[mod_by]</td>";
        echo "<td>$rowed[project_modified_on]</td>";
	echo "</tr>";
}
if ($rowed[auth_by] !="")
{
        ...
        echo "<td>$rowed[auth_by]</td>";
        echo "<td>$rowed[project_authorised_on]</td>";
        echo "</tr>";
}
if ($rowed[apprv_by] !="")
{
        echo "<tr>";
        echo "<td>APPROVED</td>";
        echo "<td>$rowed[apprv_by]</td>";
        echo "<td>$rowed[project_approved_on]</td>";
        echo "</tr>";
}
...
if ($rowed[act_by] !="")
{
        ...
        echo "<td>$rowed[act_by]</td>";
        echo "<td>$rowed[project_activated_on]</td>";
        echo "</tr>";
}
if ($rowed[delv_by] !="")
{
        ...
        echo "<td>$rowed[delv_by]</td>";
        echo "<td>$rowed[project_delivered_on]</td>";
        echo "</tr>";
}
if ($rowed[war_by] !="")
{
        echo "<tr>";
        echo "<td>MARKED FOR WARRANTY</td>";
        echo "<td>$rowed[war_by]</td>";
        echo "<td>$rowed[project_warranty_on]</td>";
        echo "</tr>";
}
if ($rowed[del_by] !="")
{
        echo "<tr>";
        echo "<td>DELETED</td>";
        echo "<td>$rowed[del_by]</td>";
        echo "<td>$rowed[project_deleted_on]</td>";
        echo "</tr>";
}
if ($rowed[deact_by] !="")
{
        ...
        echo "<td>$rowed[deact_by]</td>";
        echo "<td>$rowed[project_deactivated_on]</td>";
        echo "</tr>";
}
...
if ($rowed[close_by] !="")
{
        echo "<tr>";
        echo "<td>CLOSED</td>";
        echo "<td>$rowed[close_by]</td>";
        echo "<td>$rowed[project_closed_on]</td>";
        echo "</tr>";
}
