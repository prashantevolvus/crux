...
if(checkProjectPermission("APPROVE") == false)
{
...
Objectives, Scope, success_factor, docurl,purchase_order,project_manager_remarks,po_date,amc_pcnt
...
<br>
<td>
<font size="3" face="arial"><b>Approve Project</b></font>
</td>
<?
 if($rowed[tlr]=="GREEN")
...
echo "<b><input name='byFld' id='byFld'  type='hidden' value='project_approved_by'></b>";
echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='APPROVED'></b>";
echo "<b><input name='onFld' id='onFld'  type='hidden' value='project_approved_on'></b>";
echo "<b><input name='remFld' id='remFld'  type='hidden' value='project_appr_remarks'></b>";
?>
...
<? echo "<td>  <textarea rows=5 cols=40 id='PMRemarks' name='PMRemarks'>".$rowed[project_manager_remarks]."</textarea>";
?>
 </td>
<td>Authoriser's Comment : </td>
<? echo "
<td>  <textarea rows=5 cols=40 id='authComm' name='authComm'  requried>$rowed[project_auth_remarks]</textarea>";?>
 </td>
</tr>
<tr>
...
<? echo "
<td>  <textarea rows=5 cols=40 id='remAction' name='remAction' autofocus required>$rowed[project_appr_remarks]</textarea>";?>
 </td>
...
<tr>
<td>
<input type="submit"  value="Approve Project">
</td>
</tr>
</table>
<td> 
