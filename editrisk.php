...
$sqled="
select a.risk_id,customer_id,project_id,d.risk_type_id,c.name customer , b.project_name project_name , risk_desc,getEmpName(created_by) created_by,created_on,d.risk_type,risk_cost,
...
echo "<b><input name='projid' id='projid' type='hidden' value='$rowed[project_id]'></b>";
?>
		</td>
...
<td>  <textarea rows=5 cols=40 name="Desc" required><?php echo $rowed[risk_desc]?></textarea>
 </td>
</tr>
<tr>
<td>Containment Plan : </td>
<td>  <textarea rows=5 cols=40 name="Containment" required><?php echo $rowed[containment_plan]?></textarea>
 </td>

<td>Contingent Plan : </td>
<td>  <textarea rows=5 cols=40 name="Contingent" required><?php echo $rowed[contingent_plan]?></textarea>
 </td>
</tr>
<tr>
<td>Cost of Risk : </td>
<td><input type="number" id="riskcost" name="riskcost" step="" value="<?php echo $rowed[risk_cost]?>"></td>
</tr>
