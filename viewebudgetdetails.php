...
echo "<script>document.getElementById('budgetname').value = '$rowed[budget_name]';</script>";
echo "<script>document.getElementById('budgetname').disabled=true</script>";
