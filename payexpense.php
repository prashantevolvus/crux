...
$coned=getConnection();
$sqled="
SELECT for_emp, a.expense_id,expense_type,a.project_id project_id, c.customer_id customer_id, c.name project_name,d.name customer_name,expense_details, expense_date,expense_amt FROM expense_details a
...
?>
<h2>Pay Expense</h2>
<form name="expenseForm" action="updatepay.php" method="post" onsubmit="return formSubmit();" >
<table>
<?
...
<td> 
<input type="submit"  value="Pay Expense"> 
</td>
</form>
</body>
</html>
