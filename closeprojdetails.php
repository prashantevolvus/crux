...
if(checkProjectPermission("INITCLOSE") == false)
{
...
if($rowed[status] != "ACTIVE" and $rowed[status] != "WARRANTY" and $rowed[status] != "DELIVERED" )
...
<br>
<td>
<font size="3"><b>Initiate Project Closure</b></font>
</td>
<?php
 if($rowed[tlr]=="GREEN")
...
echo "<b><input name='statuschg' id='statuschg'  type='hidden' value='INITIATE CLOSURE'></b>";
echo "<b><input name='onFld' id='onFld'  type='hidden' value='project_closed_on'></b>";
echo "<b><input name='statusFld' id='statusFld'  type='hidden' value='project_close_status'></b>";
echo "<b><input name='remFld' id='remFld'  type='hidden' value='project_close_remarks'></b>";
?>
...
<td>  <textarea rows=5 cols=40 id="remAction" name="remAction" required></textarea>
 </td>
<td>
...
<tr>
<td>
<input type="submit"  value="Initaite Project Closure">
</td>
</tr>
</table>
<td> 
