...
$sql="
select id , ohrm_project_id,project_name from project_details where status in ('ACTIVE','DEACTIVATED','DELIVERED','WARRANTY') and ohrm_customer_id  = ".$q." order by project_name ";
